...
import (
	...
	"product-versions/internal/api"
	"product-versions/internal/cmdb"
	"product-versions/internal/logger"
	"product-versions/internal/middleware"
	"product-versions/internal/versions"
...
const (
	...
	defaultTLSDir     = "/d/d1/product-versions/tls"
	defaultCACertFile = "/etc/pki/ca-trust/source/anchors/katello-server-ca.pem"
	defaultConfigDir  = "/d/d1/product-versions/config"
)
...
// Run initializes and starts the Product Versions web service.
//
